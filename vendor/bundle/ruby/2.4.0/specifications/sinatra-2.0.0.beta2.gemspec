...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<rack-protection>.freeze, ["= 2.0.0.beta2"])
      s.add_runtime_dependency(%q<mustermann>.freeze, ["= 1.0.0.beta2"])
    else
      s.add_dependency(%q<rack>.freeze, ["~> 2.0"])
      s.add_dependency(%q<tilt>.freeze, ["~> 2.0"])
      s.add_dependency(%q<rack-protection>.freeze, ["= 2.0.0.beta2"])
      s.add_dependency(%q<mustermann>.freeze, ["= 1.0.0.beta2"])
    end
  else
    s.add_dependency(%q<rack>.freeze, ["~> 2.0"])
    s.add_dependency(%q<tilt>.freeze, ["~> 2.0"])
